...
function Header() {
  ...
  return (
    <>
      <header className='fixed left-0 top-0 z-50 w-full border-b border-neutral-200 dark:border-neutral-800 bg-white/40 dark:bg-black/40 px-2 py-2 backdrop-blur-lg'>
        <div className='mx-auto flex items-center justify-between gap-2 px-2 2xl:container'>
          ...
          <div className='flex gap-2'>
            ...
            <button
              className='hidden sm:flex flex-shrink-0 items-center space-x-2 group px-2 rounded-md bg-black dark:bg-white text-white dark:text-black border border-neutral-200 dark:border-neutral-800'
              onClick={() =>
                window.open(
            ...
            <a
              ...
              className='border border-neutral-200 dark:border-neutral-800 w-10 flex-shrink-0 place-content-center rounded-md sm:hidden grid bg-black dark:bg-white text-white dark:text-black'
            >
              <Github />
            </a>
            ...
            <a
              ...
              className='border border-neutral-200 dark:border-neutral-800 flex-shrink-0 bg-black dark:bg-white text-white dark:text-black text-2xl w-12 grid place-content-center rounded-md'
            >
              <svg
                width='120'
                height='109'
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className='relative flex-shrink-0 grid w-12 place-content-center rounded-md border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-black'>
